...
internal static class Constants {
    ...
    public const string PEBootDescription = "SimpleVHD PE로 부팅합니다.";
    ...
    public const string SwitchStyleDescription = "SimpleVHD 운영 스타일을 전환합니다.";
    public const string UninstallName = "제거";
    public const string UninstallDescription = "SimpleVHD를 제거합니다.";
