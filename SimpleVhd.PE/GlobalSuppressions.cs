...
[assembly: SuppressMessage("Reliability", "CA2000:범위를 벗어나기 전에 개체를 삭제하십시오.", Justification = "<보류 중>", Scope = "member", Target = "~M:SimpleVhd.PE.Program.Main~System.Threading.Tasks.Task")]
[assembly: SuppressMessage("Design", "BH0001:파생 형식이 없는 형식은 봉인되어야 함", Justification = "<보류 중>", Scope = "namespaceanddescendants", Target = "~N:SimpleVhd.PE.Operations")]
[assembly: SuppressMessage("Design", "CA1031:일반적인 예외 형식을 catch하지 마세요.", Justification = "<보류 중>", Scope = "member", Target = "~M:SimpleVhd.PE.Program.Main~System.Threading.Tasks.Task")]
